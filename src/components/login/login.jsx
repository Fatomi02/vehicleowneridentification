              ...
              <form action="">
                ...
                <div className="w-[90%] mt-5 mx-auto">
                  <input
                    ...
                    onClick={login}
                    value="Log In"
                    className="w-full bg-inherit cursor-pointer hover:bg-blue-800 text-center hover:text-white border-blue-700 border-[1px] mt-5 h-[40px]"
                  />
                  <button
                    className="w-full bg-inherit hover:bg-red-600 hover:text-white border-blue-700 border-[1px] mt-5 h-[40px]"
                    disabled
                  >
                    Sign In
                  </button>
